...
class AgentCommand(StrEnum):
    ...
    SNOOZE = "SNOOZE"
    # Collaborative groups (schema v18): typed, validated in groups/assistant.py.
    CREATE_SHARED_EVENT = "CREATE_SHARED_EVENT"
    UPDATE_SHARED_EVENT = "UPDATE_SHARED_EVENT"
    CANCEL_SHARED_EVENT = "CANCEL_SHARED_EVENT"
    CREATE_SHARED_OBLIGATION = "CREATE_SHARED_OBLIGATION"
    CREATE_GROUP_PROPOSAL = "CREATE_GROUP_PROPOSAL"
    APPROVE_GROUP_PROPOSAL = "APPROVE_GROUP_PROPOSAL"
    REJECT_GROUP_PROPOSAL = "REJECT_GROUP_PROPOSAL"
    SET_PERSONAL_EVENT_PREFERENCES = "SET_PERSONAL_EVENT_PREFERENCES"
    SET_PERSONAL_OBLIGATION_PREFERENCES = "SET_PERSONAL_OBLIGATION_PREFERENCES"
    CREATE_PREPARATION_TASK = "CREATE_PREPARATION_TASK"
