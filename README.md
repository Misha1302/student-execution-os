...
7. Reliability/security/conformance hardening before any production claim. **Implemented locally through schema v11; external FCM/LLM/routing/OAuth providers remain explicitly configuration-dependent.**
